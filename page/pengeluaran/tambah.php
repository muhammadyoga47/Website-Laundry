...
if (isset($_POST['tambah'])) {
  ...
  $pesan_error = "";
  $pesan_error_catatan = "";
  $pesan_error_pengeluaran = "";

  // Validasi catatan
  if (strlen($catatan) > 100) {
    $pesan_error_catatan .= "Catatan tidak boleh melebihi 50 karakter. ";
  }
  if (!preg_match("/^[a-zA-Z\s]*$/", $catatan)) {
    $pesan_error_catatan .= "Catatan hanya boleh mengandung huruf dan spasi. ";
  }

  // Validasi jumlah pengeluaran
  if (!is_numeric($pengeluaran) || $pengeluaran >= 5000000) {
    $pesan_error_pengeluaran .= "Jumlah pengeluaran harus berupa angka dan tidak boleh lebih dari Rp. 5.000.000. ";
  }

  if ($pesan_error_catatan === "" && $pesan_error_pengeluaran === "") {
          ...
          <div class="card m-b-100">
            ...
            <input type="hidden" value="<?= $id_pengeluaran; ?>" name="id_pengeluaran">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="catatan" name="catatan" cols="20" rows="5" placeholder="Masukkan catatan" required maxlength=""><?= $catatan; ?></textarea>
                  <?php if ($pesan_error_catatan !== "") : ?>
                    <div class="error" style="color: red; font-size: 12px;"><?= $pesan_error_catatan; ?></div>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  <?php if ($pesan_error_pengeluaran !== "") : ?>
                    <div class="error" style="color: red; font-size: 12px;"><?= $pesan_error_pengeluaran; ?></div>
                  <?php endif; ?>
                </div>
              </div>
